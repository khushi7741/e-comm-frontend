...
const UserSignUp = () => {
  ...
  const collectData = async () => {
    ...
    let result = await fetch("http://localhost:5000/user-sign-up", {
      method: "POST",
  ...
  return (
    <div className="h-screen w-full">
      <div className="flex gap-5 justify-center items-center h-screen w-full text-lg font-semibold xl:container mx-auto">
        <div className="w-2/5 bg-indigo-100 shadow-xl hover:shadow-indigo-300/40 p-8 m-10 rounded-lg text-indigo-600">
          <div className="flex flex-col gap-7">
            <h1 className="capitalize text-3xl">user sign up</h1>
            <div>
