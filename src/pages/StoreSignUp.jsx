...
const StoreSignUp = () => {
  ...
  const collectData = async () => {
    ...
    let result = await fetch("http://localhost:5000/store-sign-up", {
      method: "POST",
  ...
  return (
    <div className="h-screen w-full">
      <div className="flex gap-5 justify-center items-center h-screen w-full text-lg font-semibold xl:container mx-auto">
        <div className="w-2/5 bg-teal-100/50 shadow-xl hover:shadow-teal-300/40 p-8 m-10 rounded-lg text-teal-600">
          <div className="flex flex-col gap-7">
            <h1 className="capitalize text-3xl">store sign up</h1>
            <div>
              <form onSubmit={handleSubmit}>
                <div className="flex flex-col gap-5">
                  ...
                  <div>
                    <button
                      type="submit"
                      className="bg-teal-600 text-white w-full py-1 px-3 rounded-md"
                    >
                      sign up
                    </button>
                  </div>
